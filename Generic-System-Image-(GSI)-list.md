...
- *Only use GSI images with an Android version that is higher or equal to the version of Android that came with your device.*
...
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|19 Apr|Google GSI|Google|[Download](https://ci.android.com/builds/branches/aosp-android14-gsi/grid?) / [Build](https://source.android.com/docs/setup/start/initializing)|[Google](https://android.googlesource.com/platform/manifest)|ARM64 - X86|Mar 2024
...
|18 Apr|PixelOS|MisterZtr|[Download](https://github.com/MisterZtr/PixelOS_gsi/releases)|[GitHub](https://github.com/MisterZtr/PixelOS_gsi)|ARM64|Apr 2024|
