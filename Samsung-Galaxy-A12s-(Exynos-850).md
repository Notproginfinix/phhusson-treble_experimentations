...
| Superior OS                                                      	| ❌ - Went back to TWRP             	| ❌                        	| Did not boot, stuck at TWRP                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           	| NDA                                                                                                                                                                                                                                                         	| NDA                             	|
| Horizon Droid (Initial Release)                                     	| ✔️                                 	| ✔️                        	| You cannot disable Duplicate accounts.<br><br>Assistant can't be updated<br><br>One out of 4 Cameras are only working                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 	| Genshin Impact: <br><br>Avg: 17-26 FPS - Settings at Low (not very low, FPS set 60, no AA)<br><br>War Thunder: 31FPS High Resolution, Low Graphics Detail                                                                                                   	| Physwizz Kernel                 	|
